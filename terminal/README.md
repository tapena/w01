...
Be sure to use the cheatsheet in case you get stuck.
...
- Organize the top music, movies, and books of 2018
  ...
  - move to the my-favorite-things folder and copy the "media" folder, then, rename it "2018-media"
...
Add your `my-favorite-things` directory inside the terminal_solution directory and push to your own branch!

You can open up your "my-favorite-things" directory in Sublime, to see your progress. You can also use `tree` in the terminal.
